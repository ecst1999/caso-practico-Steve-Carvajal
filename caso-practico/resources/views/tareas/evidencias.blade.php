    ...
    <div id="app">
        ...
        <main class="py-4">
            ...
            <div class="container">
                ...
                <form action="{{route('tarea.evidencias')}}" method="post" class="form-group" enctype="multipart/form-data">
    
                    @csrf

                    <input type="hidden" name="caso" value="{{$tar->cas_id}}">
            
                    <label for="evidencias">Evidencias</label>
                    <input type="file" name="evidencia[]" id="evidencias" class="form-control mb-3" required>
            
                    <button class="btn btn-primary">Enviar evidencias</button>
